...
while msg[0]!=4:
    ...
    if msg[0]==1 : print("Deben ser solo números del 0-9.....")
    if msg[0]==2 : print("Debe ser 13 o más (menor o igual a 19).....")
    if msg[0]==3 : print("Número de tarjeta de crédito inválida....")   


print("Números de tarjeta de crédito válidos")
